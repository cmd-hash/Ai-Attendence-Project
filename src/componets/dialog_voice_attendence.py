...
import pandas as pd
from src.componets.dialog_attendence_results import show_attendence_result
    ...
    if st.button(
        ...
        with st.spinner('Processing audio...'):
            ...
            if not candidates_dict:
                st.error(
                    'No enrolled students have voice embeddings!'
                )
                return
